...
import { authRouter, analyticsRouter, soapNotesRouter, patientsRouter, claimsRouter, appointmentsRouter, payerContractsRouter, remittanceRouter, ssoRouter, treatmentPlansRouter, locationsRouter, aiInsightsRouter, customReportsRouter, exportRouter, onboardingRouter, practicesRouter, billingRouter, telehealthRouter, messagesRouter } from "./routes/index";
...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  // NOTE: Therapist CRUD, user management, setup, and invite routes
  // have been moved to server/routes/auth.ts
  ...
  // NOTE: Practice routes moved to server/routes/practices.ts
  // NOTE: Invite routes moved to server/routes/auth.ts
  // NOTE: Analytics routes moved to server/routes/analytics.ts
  ...
  // NOTE: Patient CRUD routes moved to server/routes/patients.ts
  ...
  // NOTE: SOAP notes CRUD and therapy bank routes moved to server/routes/soap-notes.ts
  ...
  // NOTE: Practice public-info route moved to server/routes/practices.ts
  ...
  // NOTE: GET /api/patients/:id/consents routes moved to server/routes/patients.ts
  ...
  // NOTE: Billing routes (AR aging, Stripe billing, webhook) moved to server/routes/billing.ts
  ...
  // NOTE: GET /api/patients/:id/cost-estimate moved to server/routes/patients.ts
  ...
  // NOTE: GET /api/patients/:id/eligibility routes moved to server/routes/patients.ts
  ...
  // NOTE: Appointment eligibility check/alert routes moved to server/routes/appointments.ts
  ...
  // NOTE: Claims CRUD, line items, submit, check-status, paid, deny, appeals, and
  // regenerate-appeal routes have been moved to server/routes/claims.ts
  ...
  // NOTE: Claims analytics (by-status, denial-reasons) moved to server/routes/claims.ts
  ...
  // NOTE: MFA routes moved to server/routes/auth.ts
  ...
  app.post('/api/admin/payer-credentials', isAuthenticated, isAdminOrBilling, async (req: any, res) => {
    try {
      const practiceId = getAuthorizedPracticeId(req);
  ...
  // NOTE: Patient insurance-data routes moved to server/routes/patients.ts

  // ==================== LEGACY APPOINTMENT CRUD ====================
  // NOTE: Appointment CRUD, recurring, and series routes moved to server/routes/appointments.ts
  ...
  // NOTE: Telehealth routes moved to server/routes/telehealth.ts
  // NOTE: Cancellation analytics routes moved to server/routes/analytics.ts
  ...
  // NOTE: Secure messaging routes moved to server/routes/messages.ts

  // NOTE: Patient portal-access and send-portal-link routes moved to server/routes/patients.ts

  // NOTE: Patient documents and statements routes moved to server/routes/patients.ts
  ...
  // NOTE: Patient treatment-plans and active-treatment-plan routes moved to server/routes/patients.ts
  ...
  // NOTE: Patient assessments, assessment history/latest, and assessment-schedules
  // GET routes moved to server/routes/patients.ts
  ...
  // NOTE: Patient referrals GET route moved to server/routes/patients.ts
  ...
  // NOTE: Patient payment-methods GET, GET/default, and POST routes moved to server/routes/patients.ts
  ...
  // NOTE: Patient transactions and balance routes moved to server/routes/patients.ts
  ...
  // NOTE: Patient payment-plans GET route moved to server/routes/patients.ts
