  ...
  const checkEligibilityMutation = useMutation({
    ...
    onSuccess: (data) => {
      toast({
        ...
        description: data.message || "Eligibility verified",
      });
    },
    onError: (error) => {
      toast({
        ...
        <Dialog open={showIntakeDialog} onOpenChange={setShowIntakeDialog}>
          ...
          <DialogContent className="sm:max-w-[600px] max-h-[80vh] overflow-y-auto">
            <DialogHeader>
              ...
              <DialogDescription>Add a new patient with insurance information</DialogDescription>
            </DialogHeader>
            <PatientIntakeForm practiceId={practiceId} onSuccess={handlePatientCreated} />
          </DialogContent>
        </Dialog>
      </div>
            ...
            <Card key={patient.id} className="hover:shadow-lg transition-shadow">
              <CardHeader>
                <div className="flex items-center justify-between">
                  ...
                  <Badge variant="outline">{patient.insuranceProvider || "No Insurance"}</Badge>
                </div>
              </CardHeader>
              <CardContent>
                  ...
                  <div className="flex space-x-2">
                    ...
                    {patient.insuranceProvider && (
                      ...
                      >
                        ...
                        {checkEligibilityMutation.isPending ? "..." : "Verify"}
                      </Button>
                    )}
                  </div>
                  <Button
        ...
        <Dialog open={!!selectedPatient} onOpenChange={() => setSelectedPatient(null)}>
          <DialogContent className="sm:max-w-[700px] max-h-[85vh] overflow-y-auto">
            <DialogHeader>
              ...
              <DialogDescription>Patient details and insurance information</DialogDescription>
            </DialogHeader>
                  ...
                  <div className="border-t pt-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-slate-600">
                          {selectedPatient.insuranceId || "Not provided"}
                        </p>
                      </div>
                    </div>
                    <div className="grid grid-cols-2 gap-4 mt-2">
                      <div>
                        ...
                        <p className="text-sm text-slate-600">
                          {selectedPatient.policyNumber || "Not provided"}
                        </p>
                      </div>
                      <div>
                        <label className="text-sm font-medium text-slate-700">Group Number</label>
                        <p className="text-sm text-slate-600">
                          {selectedPatient.groupNumber || "Not provided"}
                        </p>
                      </div>
                    </div>
                  </div>
