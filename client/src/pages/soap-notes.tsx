...
const ACTIVITY_CATEGORIES = [
  {
    ...
    activities: [
      "Core / Gross Motor Play - Strength",
      "Feeding / Oral-Motor - Strengthening",
      "Fine Motor Tabletop Activities - Strengthening",
      "Lycra Swing - Strength / Endurance",
      "Obstacle Course - Strength / Endurance",
      "Platform Swing - Strength / Endurance",
      "Pre-Writing / Handwriting - Hand Strength / Endurance",
      "Pumpkin / Moon Swing - Strength",
      "Rope Ladder - Strengthening",
      "Thera-Putty - Strengthening",
      "Trampoline - Strengthening",
    ],
  },
  {
    name: "Balance & Motor Planning",
    activities: [
      "Core / Gross Motor Play - Coordination",
      "Fine Motor Tabletop Activities - Coordination",
      "Lycra Swing - Neuromuscular",
      "Obstacle Course - Balance / Coordination",
      "Platform Swing - Balance",
      "Pre-Writing / Handwriting - Stability",
      "Pumpkin / Moon Swing - Core",
      "Rope Ladder - Postural Control",
      // Moved from Fine Motor & ADL per clinician review (Megan, 9/13):
      // rope ladder is a balance/motor-planning activity.
      "Rope Ladder - Functional",
      "Trampoline - Coordination",
      "Trampoline - Motor Planning",
      "Trapeze Swing - Coordination",
    ],
  },
  {
    name: "Fine Motor & ADL",
    activities: [
      "ADLs (Dressing / Self-Care)",
      "Core / Gross Motor Play - Functional",
      "Executive Function / Structured Play",
      "Feeding / Oral-Motor - ADL",
      "Feeding / Oral-Motor - Functional",
      "Fine Motor Tabletop Activities - Handwriting",
      "Obstacle Course - Functional",
      "Pre-Writing / Handwriting - Functional Fine Motor",
      "Social Play / Turn-Taking",
      "Thera-Putty - Functional",
      "Thera-Putty - Hand Manipulation",
    ],
  },
  {
    name: "Sensory & Regulation",
    activities: [
      // Swings moved here from Fine Motor & ADL per clinician review
      // (Megan, 9/13): suspended equipment is sensory/regulation work.
      "Lycra Swing - Therapeutic",
      "Platform Swing - Functional",
      "Pumpkin / Moon Swing - Functional",
      "Sensory Bin / Tactile Play",
      "Sensory Brushing - Joint Compressions",
      "Sensory Brushing - Regulation to Support Function",
      "Sensory Regulation Activities - Functional",
      "Sensory Regulation Activities - Neuro",
    ],
  },
  {
    name: "Speech Therapy",
