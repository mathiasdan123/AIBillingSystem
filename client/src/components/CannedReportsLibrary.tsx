...
const CATEGORIES: ReportCategory[] = [
  {
    ...
    reports: [
      ...
      { name: "Cancellations Report", description: "Cancellations by reason, therapist, and month", route: "/reports/cancellations", status: "coming_soon" },
      { name: "Days to Note Completion", description: "Time from visit to signed SOAP note, per therapist", route: "/reports/days-to-note-completion", status: "coming_soon" },
      { name: "Intake Completion", description: "Intake form completion rate and time-to-complete", route: "/reports/intake-completion", status: "coming_soon" },
      { name: "Referrals by Month", description: "Referral volume broken down by source", route: "/reports/referrals", status: "coming_soon" },
      { name: "Unverified Benefits", description: "Patients with no recent eligibility check", route: "/reports/unverified-benefits", status: "coming_soon" },
    ],
  },
  {
    id: "claims",
    ...
    reports: [
      ...
      { name: "Timely Filing", description: "Claims approaching the payer filing deadline", route: "/reports/timely-filing", status: "coming_soon" },
    ],
  },
  {
    id: "revenue",
    ...
    reports: [
      ...
      { name: "Adjustments Report", description: "Contractual and bad-debt adjustments", route: "/reports/adjustments", status: "coming_soon" },
    ],
  },
];
